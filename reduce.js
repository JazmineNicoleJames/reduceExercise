...
function extractValue(arr, key) {
    return arr.reduce(function(accumulator, currentPerson) {
        accumulator.push(currentPerson[key]);
        return accumulator;
    },[]);
}
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function(accu, val, indx){
        accu[indx][key] = value;
        return accu;
    },arr)
